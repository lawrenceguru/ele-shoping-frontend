                ...
                <section className="uk-section uk-section-small">
                    <div className="uk-container">
                        <div className="uk-grid-medium" data-uk-grid>
                            ...
                            <p>Welcome to letzell.com!</p>

                            <p>These terms and conditions outline the rules and regulations for the use of Letzell 's Website, located at
                                www.letzell.com.</p>

                            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use letzell.com if
                            ...
                            <p>We employ the use of cookies. By accessing letzell.com, you agreed to use cookies in agreement with the Letzell
                                's Privacy Policy. </p>
                            ...
                            <p>Unless otherwise stated, Letzell and/or its licensors own the intellectual property rights for all material on
                                letzell.com. All intellectual property rights are reserved. You may access this from letzell.com for your own
                                personal use subjected to restrictions set in these terms and conditions.</p>

                            <p>You must not:</p>
                            <ul>
                                <li>Republish material from letzell.com</li>
                                <li>Sell, rent or sub-license material from letzell.com</li>
                                <li>Reproduce, duplicate or copy material from letzell.com</li>
                                <li>Redistribute content from letzell.com</li>
                            </ul>
                            ...
                            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
                                areas of the website. Letzell does not filter, edit, publish or review Comments prior to their presence on the
                                website. Comments do not reflect the views and opinions of Letzell ,its agents and/or affiliates. Comments
                                reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
                                applicable laws, Letzell shall not be liable for the Comments or for any liability, damages or expenses caused
                                and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
                            </p>

                            <p>Letzell reserves the right to monitor all Comments and to remove any Comments which can be considered
                            ...
                            <p>You hereby grant Letzell a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
                            ...
                            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
                                ...
                                records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Letzell
                            ...
                            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
                                must inform us by sending an e-mail to Letzell . Please include your name, your organization name, contact
                            ...
                            <p>No use of Letzell 's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
