...
export default class Cookie extends Component<Props, {}> {
                ...
                <section className="uk-section uk-section-xsmall">
                    <div className="uk-container">
                        <div className="uk-grid-medium" data-uk-grid>
                            ...
                            <h2>Cookie Policy for Letzell Inc.</h2>

                            <p>At letzell, accessible from letzell.com, one of our main priorities is the privacy of our visitors. This
                                Privacy Policy document contains types of information that is collected and recorded by letzell and how we use
                                it.</p>
                            ...
                            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
                                to the information that they shared and/or collect in letzell. This policy is not applicable to any information
                            ...
                            <p>letzell follows a standard procedure of using log files. These files log visitors when they visit websites. All
                            ...
                            <p>Like any other website, letzell uses 'cookies'. These cookies are used to store information including visitors'
                            ...
                            <p>For more general information on cookies, please read <a href="https://www.generateprivacypolicy.com/#cookies">the
                            ...
                            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of letzell.</p>

                            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
                                their respective advertisements and links that appear on letzell, which are sent directly to users' browser.
                            ...
                            <p>Note that letzell has no access to or control over these cookies that are used by third-party advertisers.</p>

                            <h2>Third Party Privacy Policies</h2>

                            <p>letzell's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
                            ...
                            <p>letzell does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
