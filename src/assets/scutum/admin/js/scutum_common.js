...
scutum.$body = document.querySelector('body');
scutum.$html = document.querySelector('html');
scutum.$doc = document.querySelector(document);
scutum.$win = document.querySelector(window);
scutum.$sidebarMain = document.querySelector('#sc-sidebar-main');
scutum.$offcanvas = document.querySelector('#sc-offcanvas');
scutum.$toolbar = document.querySelector('#sc-toolbar');
scutum.$header = document.querySelector('#sc-header');
scutum.$topBar = document.querySelector('#sc-page-top-bar');
scutum.$pageContent = document.querySelector('#sc-page-content');
scutum.$pageWrapper = document.querySelector('#sc-page-wrapper');
...
scutum.init = function () {
	...
	if (document.documentMode || /Edge/.test(navigator.userAgent)) {
		document.querySelector('ul.sc-js-edge-fix').each(function () {
			document.querySelector(this).parent().prepend(document.querySelector(this).detach());
		});
	}
	// fab (speed dial)
...
scutum.uikitCustom.init = function () {
	...
	scutum.$body.addEventListener('click', '.sc-uk-dropdown-close', function(e) {
		UIkit.dropdown(document.querySelector(e.target).closest('.uk-dropdown')).hide();
	});
}
